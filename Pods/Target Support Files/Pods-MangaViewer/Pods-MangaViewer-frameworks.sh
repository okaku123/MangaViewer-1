...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NukeUI/NukeUI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PositionScrollView/PositionScrollView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImageSwiftUI/SDWebImageSwiftUI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SuperResolutionKit/SuperResolutionKit.framework"
